...
namespace Monitor
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            threads.AddRange(CreateWorkers(ewh, () => { myClass.Increase(); anClass.Decrease(); }, 10, 10000));
            threads.AddRange(CreateWorkers(ewh, () => { myClass.Decrease(); anClass.Increase(); }, 10, 10000));
